    ...
    })(
        {
                                        ...
                                        return (
                                            ...
                                            null === e[0]
                                                ...
                                                : ((i = e.slice(0, this.stability)),
                                                  ...
                                                  (o = a / i.length),
                                                  (r = s / n.length),
                                                  Math.abs(o) < Math.abs(r * this.tolerance) && this.sensitivity < Math.abs(r) ? t : !1)
                                        );
                                    }),
            ...
            8: [
                function (t, e, n) {
                    (function (n) {
                        for (
                            var i = t("performance-now"), r = "undefined" == typeof window ? n : window, s = ["moz", "webkit"], o = "AnimationFrame", a = r["request" + o], l = r["cancel" + o] || r["cancelRequest" + o], u = 0;
                            !a && u < s.length;
                            u++
                        )
                            (a = r[s[u] + "Request" + o]), (l = r[s[u] + "Cancel" + o] || r[s[u] + "CancelRequest" + o]);
                        if (!a || !l) {
                            var h = 0,
                                c = 0,
                                f = [],
                ...
                function (t, e, n) {
                    ...
                    function i(t) {
                        l(this, "_onWheel", "_onMouseWheel", "_onTouchStart", "_onTouchMove", "_onKeyDown"),
                            ...
                            (this.options = r({ mouseMultiplier: 1, touchMultiplier: 2, firefoxMultiplier: 15, keyStep: 120, preventTouch: !1, unpreventTouchClass: "vs-touchmove-allowed", limitInertia: !1 }, t)),
                    ...
                    var l = (function () {
                        ...
                        y = (function (t) {
                            function e(t) {
                                ...
                                return (
                                    n._bind(),
                                    (n.options = Object.assign({ container: t.container, blocks: t.blocks, isAnimated: t.isAnimated || !1, spring: t.spring || 0.1, skewReducer: t.skewReducer || 20, skewLimit: t.skewLimit || 30 }, t)),
                                    (n.vars = { scrollValue: 0, oldScrollValue: 0, scrollTarget: 0, scrollLeft: 0, scrollRight: 0, spring: n.options.spring, direction: 0, speed: 0, speedTarget: 0 }),
                            ...
                            return (
                                ...
                                l(e, [
                                    ...
                                    },
                                    {
                                        ...
                                        value: function () {
                                            var t = this;
                                            Object.assign(this.wrapper.style, { position: "absolute", top: "0", left: "0", "backface-visibility": "hidden", "will-change": "transform" }),
                                                Object.assign(this.options.container[0].style, { "white-space": "nowrap", position: "relative" }),
                                    ...
                                    },
                                    {
                                        key: "_onScroll",
                                        value: function (t) {
                                            t.deltaY > 0 ? (this.vars.direction = 1) : (this.vars.direction = -1),
                                    ...
                                    },
                                    {
                                        ...
                                        value: function () {
                                            ...
                                            (this.vars.speed = this._clamp(-e, -this.options.skewLimit, this.options.skewLimit)),
